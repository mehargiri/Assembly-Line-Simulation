...
This C++ program simulates a typical assembly line using Object Oriented Programming. Several custom class and subclass with custom constructor, destructor, getter and setters methods need to be created throughout this project. A line with 3 Stations is illustrated in the figure below.
...
The project is divided into 3 milestones for easier implementation, debugging and execution.
